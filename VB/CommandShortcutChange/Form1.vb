...
Namespace CommandShortcutChange
	Partial Public Class Form1
		...
		Public Sub New()
			...
			Dim svc1 As RichEditKeyboardHandlerService = CType(richEditControl1.GetService(Of IKeyboardHandlerService)(), RichEditKeyboardHandlerService)
			Dim handler1 As NormalKeyboardHandler = GetKeyboardHandler(svc1.Control)
			...
			Dim svc2 As RichEditKeyboardHandlerService = CType(richEditControl2.GetService(Of IKeyboardHandlerService)(), RichEditKeyboardHandlerService)
			Dim handler2 As NormalKeyboardHandler = GetKeyboardHandler(svc2.Control)
		...
		Private Function GetKeyboardHandler(ByVal control As DevExpress.XtraRichEdit.Internal.InnerRichEditControl) As NormalKeyboardHandler
